"""Hasting's faster implementation of the car racing environment."""
import numpy as np
import math
...
class CarRacing(gym.Env, EzPickle):
    ...
    def _create_track(self):  # noqa: C901
        CHECKPOINTS = 12
    ...
    def render_road(self):
        if self.initialized < 3:
            ...
            gl.glBufferData(
                gl.GL_ARRAY_BUFFER_ARB, len(colors) * 4, gl_colors, gl.GL_STATIC_DRAW
            )
