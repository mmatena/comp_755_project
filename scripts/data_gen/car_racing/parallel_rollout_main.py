...
flags.DEFINE_integer('num_rollouts', None, 'The gross total number of rollouts to generate.', lower_bound=1)
flags.DEFINE_integer('parallelism', None, 'The number of rollouts to do in parallel.', lower_bound=1)
flags.DEFINE_integer('max_steps', None, 'The maximum number of steps in each rollout.', lower_bound=1)
